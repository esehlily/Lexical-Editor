...
import { i as o, n as getPeerDependencyFromEditor, r as namedSignals, t as E } from "./LexicalExtension.dev-DJIxxTFy.js";
...
var HistoryExtension = defineExtension({
	build: (editor, { delay, createInitialHistoryState, disabled, now }) => namedSignals({
		delay,
		disabled,
	...
	register: (editor, config, state) => {
		...
		return E(() => stores.disabled.value ? void 0 : registerHistory(editor, stores.historyState.value, stores.delay, () => stores.now.peek()()));
	}
});
...
//# sourceMappingURL=@lexical_history.js.map